...
\begin{tikzpicture}
	...
	\end{axis}
\end{tikzpicture}
\caption{The different algorithm's score on \emph{PAutomaC}'s 6th data set, according to the perplexity measure used in the competition.}
...
\begin{tikzpicture}
	...
	\end{axis}
\end{tikzpicture}
\caption{The different algorithm's score on \emph{PAutomaC}'s 35th data set, according to the perplexity measure used in the competition.}
