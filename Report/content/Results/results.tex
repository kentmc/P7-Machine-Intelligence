...
\begin{tikzpicture}
	...
	\end{axis}
\end{tikzpicture}
\caption{The different algorithm's score on Pautomac's 6th data set, according to the perplexity measure used in the competition.}\label{fig:pautomac-competition-6}
\end{figure}
...
\begin{tikzpicture}
	...
	\end{axis}
\end{tikzpicture}
\caption{The different algorithm's score on Pautomac's 23rd data set, according to the perplexity measure used in the competition.}\label{fig:pautomac-competition-23}
\end{figure}
...
\begin{tikzpicture}
	...
	\end{axis}
\end{tikzpicture}
\caption{The different algorithm's score on Pautomac's 35th data set, according to the perplexity measure used in the competition.}\label{fig:pautomac-competition-35}
\end{figure}